  ...
  Components = [
    {
      ...
      description : "A small implementation of the popular Game of Life by <a href='https://de.wikipedia.org/wiki/John_Horton_Conway'>John Conway</a>.<br>It features the option to change the needed neighbors to get born, to die or to stay alive.<br>With this you can create pretty funky stuff!",
    },
    {
      name:"A* Pathfinder",
