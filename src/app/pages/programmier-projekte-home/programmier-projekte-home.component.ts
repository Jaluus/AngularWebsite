...
export class ProgrammierProjekteHomeComponent implements OnInit {
  ...
  Components = [
    ...
    imagePath:"https://backend.uslu.tech/pictures/UnityFractal/ThumbImageFractal.png",
    link:this.links.PpNavArr[0].route,
    description :
    `A fractal generator and explorer i've written in the Unity game engine entirely from scratch,<br>
  ...
  },
    {
      ...
      description :
      `A small implementation of the popular Game of Life by <a href='https://de.wikipedia.org/wiki/John_Horton_Conway'>John Conway</a>.<br>
    ...
    },
    {
      ...
      description :
      `A fast Pathfinding Algorithm to find the shortest way between to nodes in a graph.<br>
